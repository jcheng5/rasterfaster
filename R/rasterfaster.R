...
system.time(r <- resampleTo(raster("shipping.grd"), 360, 720, method = "bilinear")); plot(r); expect_equal(digest(values(r)), "2c636751c2ab5b0f9e08c67331e6b793")
...
system.time(r <- resampleTo(raster("acid.grd"), method = "bilinear")); plot(r); expect_equal(digest(values(r)), "0bb199341851e627d0c3e33c44a9fbf9")
})
